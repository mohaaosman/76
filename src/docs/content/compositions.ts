...
export const templates: Composition[] = [
  ...
  },
  {
    ...
    description: [
      'Rides the <b>Plate</b> (B24) — the band-less page type: wall, one centred card, the mono wordmark, no navigation to leave by. Three stacked <b>SocialButton</b>s sit above a hairline "or" rule, then email and password on the B11 timing contract.',
    ...
    tags: ['auth', 'sign-in', 'login', 'plate', 'cobalt'],
    file: 'templates/auth-sign-in.tsx',
    deps: ['plate', 'social-button', 'field', 'button', 'banner'],
  },
  {
    slug: 'auth-sign-up',
    kind: 'template',
    ...
    tags: ['auth', 'sign-up', 'registration', 'plate', 'cobalt'],
  ...
  },
  {
    ...
    tags: ['auth', 'password-reset', 'forgot-password', 'plate', 'cobalt'],
    file: 'templates/auth-forgot.tsx',
    deps: ['plate', 'field', 'button', 'banner'],
  },
  {
    slug: 'auth-reset',
    kind: 'template',
    ...
    tags: ['auth', 'password-reset', 'new-password', 'plate'],
  ...
  },
  {
    ...
    tags: ['auth', 'otp', 'verification-code', 'pin-field', 'plate'],
    file: 'templates/auth-verify.tsx',
    deps: ['plate', 'pin-field', 'button', 'banner'],
  },
  {
    slug: 'auth-invite',
    kind: 'template',
    ...
    tags: ['auth', 'invitation', 'onboarding', 'plate', 'cobalt'],
