...
2. **[76-COMPONENT-BOOK.md](76-COMPONENT-BOOK.md)** — the Component Book,
   B1–B18: anatomy, states, accessibility contract, and the Don't list for
...
(A1 + Part E, 15 machine-checkable rules, CI-gateable) and the 14-point Ship
Gate in `skill/seventy-six-design/references/firewall-and-copy.md`. The
